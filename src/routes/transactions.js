...
// Un 'purchase' n'exige un montant que sur les programmes points/giftcard.
// Sur une carte à tampons, le vendeur clique juste "+1 coche" : pas de montant.
// -> la validation du 'purchase' se fait dans loyalty.js, qui connaît le type du programme.
const AMOUNT_REQUIRED_TYPES = ['add_points', 'remove_points'];
